                ...
                <div class="modal-body">
                	<form method="POST" id="lockForms">
                		<table border="0" align="center" width="100%">
                			...
                			<tr>
                				<td>Liter/Gram</td>
								<td><input type="text" name="size" class="form-control" autocomplete="off" placeholder="Enter Liter/Gram" required><br></td>
                			</tr>
                			<tr>
                ...
                <div class="modal-body">
                	<form method="POST" id="lockForms2">
                		<table border="0" align="center" width="100%">
                			...
                			<tr>
                				<td>Liter/Gram</td>
								<td><input type="text" name="usize" id="usize" class="form-control" autocomplete="off" placeholder="Enter Liter/Gram" required><br></td>
                			</tr>
                			<tr>
                			...
                			<tr>
                				<td>Enter Qty</td>
								<td><input type="number" name="uqty" id="uqty" class="form-control" autocomplete="off" placeholder="Enter Qty" required><br></td>
                			</tr>
                			<tr>
...
$(document).ready(function () {
	...
	function show() {
		var num = $('#show').val();
		$.ajax({
	        url: "operation.php?from=product&operation=show&num="+num,
	        type: 'GET',
	        async: false,
	        success: function (info) {
		 		//alert(info);
	...
	function status(id,status) {
		$.ajax({
	        url: "operation.php?from=product&operation=status&id="+id+"&status="+status,
	        type: 'GET',
	        async: false,
	        success: function (info) {
		 		//alert(info);
