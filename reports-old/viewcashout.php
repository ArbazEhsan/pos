...
<center><h1>Cash Out Detail</h1></center><hr>
<form method="POST">
<div class="container">
...
<div class="row">
	...
	<div class="col-md-4 pull-right">
		<input type="text" id="myInput" class="form-control" onkeyup="myFunction()" placeholder="Search for Date..">
	</div>
</div>
</div>
</form><hr>
...
<!-- <div class="row">
	<ul> -->
		<!-- <li><center><strong>Customer:&nbsp;</strong><u><b><?php echo $customer; ?>&nbsp;</b></center></li> -->
		
		<!-- <li>
		<label>Report: <?php echo $startdate.' to '.$enddate;?></label></li>
		<li><label>Cash Out Detail Report</label></li>
	</ul>
</div> -->
...
<div class="row">
	...
	if (isset($_POST['btn']))
 	{ 
 	$counter=0;$sum = 0;
  	$result1 = mysqli_query($con,"SELECT * FROM trans WHERE day BETWEEN '$startdate' AND '$enddate' AND type='PV' OR type='CO' ORDER BY day");
...
<?php $sum = $sum + $fetch1['amount']; 	 }
	...
	</tbody><tr><td colspan="5"></td><td class="pull-right"><b>Total</b></td><td style="border:2px solid black;font-weight: bold;"><?php echo number_format($sum,0); ?></td></tr>
	</table>
</div>
</div>
...
<script type="text/javascript">
	...
	{
		if (source=='PV') {
			window.open('../2/purchaseInvPrint.php?pur_No='+str,'popUpWindow','height=400,width=1000,left=50,top=50,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');
		}
		else {
			window.open('../trans/printcashout.php?sale_No='+str,'popUpWindow','height=400,width=1000,left=50,top=50,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');
		}
	}
</script>
