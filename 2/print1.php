...
<body><br>
 ...
 if(isset($_GET['sale_No']))
 {
  ...
  $sql1     = "SELECT * FROM pcounter WHERE id = '$sale_No'";
  ...
  $sql      = "SELECT * FROM pcounter WHERE id='$sale_No'";
...
<div class="party">
 ...
 <table style="margin-top: -20px;">
   <tr><th>Customer :</th><td><?php echo $fetch2['name']." (".$fetch['transport_By'].")"; ?></td><th>| Address :</th><td><?php echo $fetch2['address']; ?></td></tr>
</table>

</div>
<br>
<center><h3 style="margin-top: -20px;"><u><em>Order Invoice</em></u></h3></center>
<table class="main" border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: center;margin-top: -15px;">
 ...
 $remaining=0;
 $finalValue=0;
      $query3   =   "SELECT * FROM psale WHERE sale_No ='$sale_No' ";
