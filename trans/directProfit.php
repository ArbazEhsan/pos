...
<title>Direct Profit</title><?php include('../session.php'); include('../header.php');include('../connect.php');

if (isset($_GET['id'])) {
    mysqli_query($con,"DELETE FROM cashin WHERE id='".$_GET['id']."'");
    mysqli_query($con,"DELETE FROM shopledger WHERE cashin_Id='".$_GET['id']."'");
    header("Location:directProfit.php?Deleted");
}
?>
...
<center><h1>Add Direct Profit</h1></center><hr>
<div class="container">
<form id="formId"> <div class="row">
  ...
  <div class="row">
    <div class="col-md-3">
      <input type="" name="amount" class="form-control" placeholder="Amount">
    </div>
  </div><br>
  <div class="row">
    <div class="col-md-3">
...
<div class="row"><br><br>
  ...
  <tbody>
    <?php
    $counter=0;
         $result=mysqli_query($con," SELECT * FROM cashin WHERE type='Direct Profit'");
         ...
         {$counter++;
          ...
          <td> <a href="directProfit.php?id=<?php echo $fetch['id'];?>" class="btn btn-danger">Delete</a>
             <a href="editDirectProfit.php?id=<?php echo $fetch['id'];?>" class="btn btn-primary">Edit</a>
            <td>
          </tr>
        <?php }  ?>
