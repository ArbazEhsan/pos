...
<div class="container-fluid">
	...
	<div class="col-md-12">
  			...
  			<center><h2>Day End Report  <u><?php if($_POST['day']!=''){
				echo date("d/m/Y", strtotime($_POST['day']));
			}?></u></h2></center>
	...
	<div class="col-md-12">
		<table class="main" border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: center;margin-top: 10px;">
			...
			<th>Remaining</th>			
			 ...
			 <?php $c2 = 0;			 
			 	$r2 = mysqli_query($con,"SELECT * FROM pcounter WHERE sale_day = '$day'");
			 	while($fetch2 = mysqli_fetch_array($r2))
			 	{ $c2++;
			 		$r3 = mysqli_query($con,"SELECT * FROM psale WHERE sale_No='".$fetch2['id']."'");
	...
	<div class="col-md-12">
		<table class="main" border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: center;margin-top: 10px;">
			...
			<th>Naration</th>			
			 ...
			 <?php $c3 = 0;			 
			 	$r4 = mysqli_query($con,"SELECT * FROM trans WHERE day = '$day'");
			 	...
			 	{ $c3++;
			 		...
			 		echo "<tr>".
			 				...
			 				"<td>".$fetch4['amount']."</td>".		 				
			 				"<td>".getCustomerName($fetch4['account_id'])."</td>".
			 				
			 				"<td>".$fetch4['remarks']."</td>". 				
			 		     "</tr>";
			 	}
			 ?>
		</table>
	...
	<div class="col-md-12">
		<table class="main" border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: center;margin-top: 10px;">
			...
			<th>Naration</th>			
			 ...
			 <?php $c5 = 0;			 
			 	$r5 = mysqli_query($con,"SELECT * FROM trans WHERE day = '$day'");
			 	...
			 	{ $c5++;
			 		...
			 		echo "<tr>".
			 				...
			 				"<td>".$fetch5['amount']."</td>".		 				
			 				"<td>".getCustomerName($fetch5['account_id'])."</td>".
			 				
			 				"<td>".$fetch5['remarks']."</td>". 				
			 		     "</tr>";
			 	}
			 ?>
		</table>
