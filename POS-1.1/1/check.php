...
<h5>Here you can perform all actions</h5><hr>
	<div class="row">
		...
		<div class="col-md-3">
			<a href="deals.php"><button style="font-size: 166%; border-radius: 50px;" class="alert alert-info btn-block"><b>Create Deals</b></button></a>
		</div>
		<div class="col-md-3">
			<a href="viewDeal.php"><button style="font-size: 166%; border-radius: 50px;" class="alert alert-info btn-block"><b>View Deals</b></button></a>
		</div>
	</div>
<div class="row">
		...
		<div class="col-md-3">
		 ...
		 <div class="col-md-3">
			<a href="../reports/productStockIn.php"><button style="font-size: 166%; border-radius: 50px;" class="alert alert-success btn-block"><b>Stock Report</b></button></a><br>
		</div>
		<div class="col-md-3">
			<a href="stockForm.php"><button style="font-size: 166%; border-radius: 50px;" class="alert alert-success btn-block"><b>Stock Items</b></button></a><br>
		</div>
	</div>
<!-- 	<div class="row">
		<div class="col-md-5">
