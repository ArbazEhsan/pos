...
$(document).ready(function () {
	$('#sigin').click(function () {
		if(!$("#lockForms")[0].checkValidity()){
			...
			$.ajax({
		        url: "operation.php?from=category&operation=insert",
		        type: 'POST',
		        data: formData,
		        async: false,
	...
	$('#update').click(function () {
		if(!$("#lockForms2")[0].checkValidity()){
			...
			$.ajax({
		        url: "operation.php?from=category&operation=update",
		        type: 'POST',
		        data: formData,
		        async: false,
		        success: function (info) {
	...
	function show() {
		var num = $('#show').val();
		$.ajax({
	        url: "operation.php?from=category&operation=show&num="+num,
	        type: 'GET',
	        async: false,
	        success: function (info) {
		 		//alert(info);
	...
	function status(id,status) {
		$.ajax({
	        url: "operation.php?from=category&operation=status&id="+id+"&status="+status,
	        type: 'GET',
	        async: false,
	        success: function (info) {
		 		//alert(info);
	...
	function edit(id) {
		$.ajax({
	        url: "operation.php?from=category&operation=edit&id="+id,
	        type: 'GET',
	        async: false,
	        success: function (info) {
		 		// alert(info);
