...
include('../converter.php');include('../header.php');
  ...
  if (isset($_POST['btn1'])) {
  	...
  	mysqli_query($con,"UPDATE cashin SET amount='$amount',day='$day',naration='$naration' WHERE id='$id'");
    mysqli_query($con,"UPDATE shopledger SET cr='$amount',day='$day',naration='$naration' WHERE cashin_Id='$id'");
  	header("Location:directProfit.php?Updated");
  }
  $result = mysqli_query($con,"SELECT * FROM cashin WHERE id='$id'");
...
<nav aria-label="..." style="position: fixed;">
  <ul class="pager">
    <li class="previous"><a href="directProfit.php"><span aria-hidden="true">&larr;</span> Back</a></li>
  </ul>
  <body>
</nav>
<center><h1>Edit Direct Profit</h1></center><hr>
<div class="container">
<form  method="post"> 
	<div class="row">
		<div class="col-md-3">
