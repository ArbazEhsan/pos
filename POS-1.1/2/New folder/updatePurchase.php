...
$remaining    =$_REQUEST['remaining'];
 ...
 foreach ($barcode1  as $key => $value) 
 {
 	...
 	mysqli_query($con,"INSERT INTO `psale`(`sale_No`, `barcode`, `qty`, `price`, `grossId`, `discount`, `finalValue`, `received`, `remaining`,`sale_day`,`w_price`,`r_price`) VALUES ('$orderno','$barcode1[$key]','$qty1[$key]','$price1[$key]','$grossId','$discount','$finalValue','$received','$remaining','$sale_day','$w_price1[$key]','$r_price1[$key]')");
 }
