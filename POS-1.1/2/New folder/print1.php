...
<body>
 ...
 if(isset($_GET['pur_No']))
 {
  ...
  $sql      = "SELECT * FROM psale WHERE sale_No='$sale_No'";
 ...
 <div style="margin-top: 0px;">
  ...
  <table class=""><br><br>
    <tr><td><h4>Invoice No: </h4></td><td><h4><?php echo $sale_No. " | ". date("d-m-Y", strtotime($day))." | ". date("h:i-a"); ?></h4></td></tr>
...
<div class="party">
 ...
 <table style="margin-top: -20px;">
   <tr><th>Customer :</th><td><?php echo $fetch2['name']; ?></td></tr>
</table>
