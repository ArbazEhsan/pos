...
<div class="row">
	...
	if (isset($_POST['btn']))
 	{ 
 	$counter=0;$sum = 0;
  	$result1 = mysqli_query($con,"SELECT * FROM cashout WHERE  day BETWEEN '$startdate' AND '$enddate' ORDER BY day");
  	 while($fetch1=mysqli_fetch_array($result1))
  	 {
  	 	...
  	 	<tr>
	       	...
	       	<td><?php echo $fetch1['naration']; ?></td>
...
<?php $sum = $sum + $fetch1['amount']; 	 }
	...
	</tbody><tr><td colspan="5"></td><td class="pull-right"><b>Total</b></td><td style="border:2px solid black;font-weight: bold;"><?php echo $sum; ?></td></tr>
	</table>
</div>
</div>
