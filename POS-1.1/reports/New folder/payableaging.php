...
<center><h1>Payable Invoice Report</h1></center><hr>
<form method="POST">
<div class="container">
	<div class="row">
	...
	<div class="col-md-4">
		...
		<input type="" class="form-control" name="person" required="" value="<?php echo $person; ?>"><br>
	</div>
	<div class="col-md-4">
...
<div class="row">
	...
	<ul>
		...
		<li><center><strong>Payable Report</strong></center>	</li>
		<li><label>User:&nbsp;</label> <u><b><?php echo $person; ?>&nbsp;</b></li>
...
<div class="row">
	<table border="1" class="table" id="myTable" width="100%">
		...
		if (isset($_POST['btn'])) {
		 ...
		 if ($customername !='') {
		 	...
		 	$id = $fetch1['id'];
		 	$result2 = mysqli_query($con,"SELECT id,customer,SUM(cr) AS credit,SUM(db) AS debit FROM customerledger WHERE customer='$id' GROUP BY customer");
		 }
		...
		{    
			if ($fetch2['credit'] > $fetch2['debit']) {$counter++;
	...
	?>
 	...
 	</tbody><tr><td></td><td><b>Total</b></td><td style="border:2px solid black"><?php echo $sum; ?></td></tr>
	<!-- <tr>
	<td colspan="5"></td>
